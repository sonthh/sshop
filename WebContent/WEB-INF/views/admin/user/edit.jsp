          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider">Sửa người dùng<span class="card-subtitle">Sửa người dùng với một quyền nhất định</span></div>
                <div class="card-body">
                  <form action="${pageContext.request.contextPath}/admin/user/edit/${objUser.id}-${page}" method="post">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-10 col-lg-10">
                        <input class="form-control" id="username" name="username" value="${objUser.username}" readonly="readonly" type="text" placeholder="Username">
