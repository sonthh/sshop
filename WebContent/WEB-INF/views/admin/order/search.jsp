                    ...
                    <table class="table table-striped table-hover table-bordered" style="border: 1px solid #dee2e6;">
                      ...
                      <tbody>
                        <c:choose>
                          <c:when test="${not empty listOrders}">
                            <c:forEach items="${listOrders}" var="itemOrder">
                              ...
                              <tr class="${rowClass}">
                                ...
                                <td class="cell-detail"><span>${fn:replace(itemOrder.fullname, searchString, styleSearchString)}</span></td>
                                ...
                                <td class="cell-detail"><span>${itemOrder.amount}</span></td>
                          ...
                          <c:otherwise>
                            <td class="cell-detail text-center" colspan="11"><span>Không order nào của <span class="d-inline text-danger">${searchString}</span></span></td>
                          </c:otherwise>
                        </c:choose>
                      </tbody>
                    </table>
		    ...
		    <div class="col-sm-12 d-sm-flex justify-content-sm-center">
                ...
                <c:if test="${not empty paginations}">
                  ...
                  <c:choose>
                    ...
                    <c:otherwise>
                      <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/admin/order/search-${searchString}-${page - 1}" aria-label="Previous"><span class="mdi mdi-chevron-left" aria-hidden="true"></span></a></li>
                    </c:otherwise>
                  </c:choose>
                  ...
                  <c:forEach items="${paginations }" var="itemPagination">
                    <c:choose>
                      <c:when test="${itemPagination == page }">
                        <li class="page-item active"><a class="page-link" href="${pageContext.request.contextPath}/admin/order/search-${searchString}-${itemPagination}">${itemPagination}</a></li>
                      </c:when>
                      ...
                      <c:otherwise>
                        <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/admin/order/search-${searchString}-${itemPagination}">${itemPagination}</a></li>
                      </c:otherwise>
                    </c:choose>
                  </c:forEach>
                  ...
                  <c:choose>
                    ...
                    <c:otherwise>
                      <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/admin/order/search-${searchString}-${page + 1}" aria-label="Next"><span class="mdi mdi-chevron-right" aria-hidden="true"></span></a></li>
                    </c:otherwise>
                  </c:choose>
