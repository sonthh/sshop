...
<div class="col-sm-9 padding-right">
  <div class="features_items">
    <h2 class="title text-center">Search for: ${searchString}</h2>
    ...
    <c:choose>
      ...
      <c:otherwise>Không có kết quả phù hợp với ${searchString}</c:otherwise>
    </c:choose>
    ...
    <div style="clear: both; ">
      ...
      <c:if test="${not empty paginations}">
        ...
        <c:choose>
          ...
          <c:otherwise>
            <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/search/${catName}/${searchString}/page-${page - 1}" rel="next" aria-label="Next &amp;raquo;">‹</a></li>
          </c:otherwise>
        </c:choose>
        ...
        <c:forEach items="${paginations }" var="itemPagination">
          <c:choose>
            ...
            <c:otherwise>
              <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/search/${catName}/${searchString}/page-${itemPagination}">${itemPagination}</a></li>
            </c:otherwise>
          </c:choose>
        </c:forEach>
